...
| [GUI-World](https://gui-world.github.io/) | - | Temporal GUI video data with diverse scenarios and agent behaviors for evaluating multimodal models. |
...
| [WebUI](https://arxiv.org/abs/2301.05767) | 400K screenshots | Web UI screenshots paired with HTML, accessibility trees, and metadata. |
...
| [Design2Code](https://huggingface.co/datasets/design2code/design2code-bench) | 484 pages | Real-world web pages with screenshots and HTML/CSS for visual design to code evaluation. |
| [ShowUI-Desktop](https://huggingface.co/datasets/showlab/ShowUI-desktop) | - | Annotated desktop screenshots with bounding boxes and element labels for GUI grounding. |

## 🔗 Related Resources

- [Awesome-GUI-Agent](https://github.com/showlab/Awesome-GUI-Agent) - A curated list of GUI agents (the brain side).
- [GUI-Agents-Paper-List](https://github.com/codingwatching/GUI-Agents-Paper-List) - Comprehensive paper list on GUI agents.
...
[![Star History Chart](https://api.star-history.com/svg?repos=gpengzhi/Awesome-GUI-World-Model&type=Date)](https://star-history.com/#gpengzhi/Awesome-GUI-World-Model&Date)
